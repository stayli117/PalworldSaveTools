...
class PalInfoWidget(PalInfoDisplayMixin, PalInfoHandlerMixin, QFrame):
    ...
    def _build(self):
        ...
        self._a_shortcut = QShortcut(QKeySequence(Qt.Key_A), self)
        self._a_shortcut.activated.connect(lambda: self.last_clicked_data is not None and self._on_all_passives())
    ...
    def _build_header(self, parent):
        ...
        self.info_max_buff_btn.clicked.connect(self._on_max_buff_click)
        next_row.addWidget(self.info_max_buff_btn)
        ...
        self.instance_id_lbl = QPushButton('')
        self.instance_id_lbl.setFlat(True)
        self.instance_id_lbl.setStyleSheet('QPushButton { font-size: 11px; font-weight: 700; color: #FFFFFF; background: transparent; border: none; text-align: left; padding: 0; } QPushButton:hover { color: #7DD3FC; } QPushButton:pressed { color: #60B0E0; } QToolTip { background: rgba(18,20,24,0.98); color: #E2E8F0; border: 1px solid rgba(125,211,252,0.25); border-radius: 6px; padding: 6px 10px; font-size: 11px; }')
        ...
        self.instance_id_lbl.clicked.connect(lambda: (QApplication.clipboard().setText(self.instance_id_lbl.text()), None))
    ...
    def _build_skills(self, parent):
        ...
        self._as_page_lbl.setFixedWidth(28)
        ...
        self._ps_page_lbl.setFixedWidth(28)
        ...
        self._all_passives_btn = QPushButton('[A]')
        self._all_passives_btn.setFixedSize(22, 14)
        self._all_passives_btn.setStyleSheet('QPushButton { font-size: 7px; font-weight: 700; color: #F59E0B; background: rgba(245,158,11,0.1); border: 1px solid rgba(245,158,11,0.35); border-radius: 3px; padding: 0px; margin: 0px; } QPushButton:hover { background: rgba(245,158,11,0.2); color: #FFFFFF; }')
        self._all_passives_btn.setCursor(Qt.PointingHandCursor)
        self._all_passives_btn.setToolTip(t('edit_pals.all_passives_hint'))
        self._all_passives_btn.clicked.connect(lambda: self.last_clicked_data is not None and self._on_all_passives())
        self._all_passives_btn.setVisible(PalFrame._cheat_mode)
        passive_header.addWidget(self._all_passives_btn)
        self._select_passives_btn = QPushButton('[S]')
        self._select_passives_btn.setFixedSize(22, 14)
        self._select_passives_btn.setStyleSheet('QPushButton { font-size: 7px; font-weight: 700; color: #38BDF8; background: rgba(56,189,248,0.1); border: 1px solid rgba(56,189,248,0.35); border-radius: 3px; padding: 0px; margin: 0px; } QPushButton:hover { background: rgba(56,189,248,0.2); color: #FFFFFF; }')
        self._select_passives_btn.setCursor(Qt.PointingHandCursor)
        self._select_passives_btn.setToolTip(t('edit_pals.select_passives_hint'))
        self._select_passives_btn.clicked.connect(lambda: self.last_clicked_data is not None and self._on_select_passives())
        self._select_passives_btn.setVisible(PalFrame._cheat_mode)
        passive_header.addWidget(self._select_passives_btn)
