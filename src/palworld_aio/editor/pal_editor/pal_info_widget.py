...
class PalInfoWidget(PalInfoDisplayMixin, PalInfoHandlerMixin, QFrame):
    ...
    def _build_skills(self, parent):
        ...
        self._as_add_btn = QPushButton('+')
        self._as_add_btn.setFixedSize(16, 14)
        self._as_add_btn.setStyleSheet('QPushButton { font-size: 10px; font-weight: 700; color: #4ADE80; background: rgba(74,222,128,0.1); border: 1px solid rgba(74,222,128,0.2); border-radius: 3px; padding: 0px; margin: 0px; } QPushButton:hover { background: rgba(74,222,128,0.2); color: #FFFFFF; } QToolTip { background: rgba(18,20,24,0.98); color: #E2E8F0; border: 1px solid rgba(125,211,252,0.25); border-radius: 6px; padding: 6px 10px; font-size: 11px; }')
        self._as_add_btn.setCursor(Qt.PointingHandCursor)
        self._as_add_btn.setToolTip(t('edit_pals.add_active_skill', default='Add Active Skill'))
        self._as_add_btn.clicked.connect(self._on_add_active_skill)
        as_header.addWidget(self._as_add_btn)
