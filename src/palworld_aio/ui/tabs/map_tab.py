...
class MapTab(QWidget):
    ...
    def _create_zone_shape_buttons(self):
        ...
        self._zone_shape_btn_rect.setToolTip(t('map.zone.rectangle') if t else 'Rectangle Zone')
        ...
        self._zone_shape_btn_poly.setToolTip(t('map.zone.polygon') if t else 'Polygon Zone')
