...
class CharacterTransferWindow(QWidget):
    ...
    def setup_ui(self):
        ...
        self.src_xgp_btn.setToolTip(t('Load a GamePass save from the container as source'))
        ...
        self.tgt_xgp_btn.setToolTip(t('Load the GamePass save currently open in PST as target'))
