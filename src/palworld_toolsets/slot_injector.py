...
class SlotNumUpdaterApp(QDialog):
    ...
    def setup_ui(self):
        ...
        self.xgp_load_btn.setToolTip(t('Load a GamePass save from the container'))
        ...
        self.new_slots_entry.setToolTip(t('Set the new maximum number of slots for selected containers'))
